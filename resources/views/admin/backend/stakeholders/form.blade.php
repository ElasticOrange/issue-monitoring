...
<div class="tab-content">
    ...
    <div class="tab-pane active" id="ro">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="profile[ro]" class="form-control" rows="3" id="editor1">{{ $stakeholder->translateOrNew('ro')->profile }}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="position[ro]" class="form-control" rows="3" id="editor2">{{ $stakeholder->translateOrNew('ro')->position }}</textarea>
            </div>
        </div>
    ...
    <div class="tab-pane" id="en">
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="profile[en]" class="form-control" rows="3" id="editor3">{{ $stakeholder->translateOrNew('en')->profile }}</textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                <textarea name="position[en]" class="form-control" rows="3" id="editor4">{{ $stakeholder->translateOrNew('en')->profile }}</textarea>
            </div>
        </div>
