                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                            <td align="left" style="padding: 0 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy"><ul><b>{{ $alert->alertable->flow_name }}</b></ul></td>
                                        </tr>
                                        <tr>
                                            <td align="left" style="padding: 0 0 0 0; font-size: 16px; line-height: 25px; font-family: Helvetica, Arial, sans-serif; color: #666666;" class="padding-copy"><ul>{{ strip_tags($alert->alertable->observatii) }} </ul>
                                                <ul><a href="{{ action('EmailViewController@getExternalIssueInfo', [$alert->alertable->id, Illuminate\Support\Str::slug($alert->alertable->flowstepsInLocation->issue->name)]) }}">Vezi pagina initiativei pentru mai multe informatii!</a></ul></td>
                                        </tr>
                                        <tr>
